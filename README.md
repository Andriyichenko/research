...
|--------|-------------|------|
| **ML 2.2** | シグモイド関数 (Sigmoid Function) | [ML2.2.pdf](https://github.com/Andriyichenko/research/semi/out/ml2.2.pdf) |
| | 講義スライド (Slides) | [ml2.2-ppt.pdf](https://github.com/Andriyichenko/research/semi/out/ml2.2-ppt.pdf) |
| **ML 3.5-3.6** | 交差エントロピー (Cross-Entropy) | [ML3.5-3.6.pdf](https://github.com/Andriyichenko/research/semi/ML3.5-3.6/out/ml3.5-3.6.pdf) |
| **ML 3.10** | 平均二乗誤差 (Mean Squared Error) | [ML3.10.pdf](https://github.com/Andriyichenko/research/semi/ML3.10/out/ml3.10.pdf) |
| **ML 3.11** | 正則化 (Regularization) | [ml3.11.pdf](https://github.com/Andriyichenko/research/semi/ML3.11/out/ml3.11.pdf) |
| **ML 4.2** | 最急降下法 (Steepest Descent) | [ML4.2.pdf](https://github.com/Andriyichenko/research/semi/ML4.2/out/ml4.2.pdf) |
| **ML 4.2.4** | 直線探索法 (Line Search Method) | [ML4.2.4.pdf](https://github.com/Andriyichenko/research/semi/ML4.2.4/out/ml4.2.4.pdf) |
| **ML 4.3** |  物理の運動学からの解釈(Kinematic Interpretation) | [ML4.3.pdf](https://github.com/Andriyichenko/research/semi/ML4.3/out/ml4.3.pdf) |
| **ML 4.4** |  モーメンタム法(Momentum Method) | [ML4.4.pdf](https://github.com/Andriyichenko/research/semi/ML4.4/out/ml4.4_momentum_method.pdf) |
| **Proofs** | 畳み込みの証明 (Convolution) | [pf_convolution.pdf](https://github.com/Andriyichenko/research/blob/main/semi/ML4.4/out/ml4.4_momentum_method.pdf) |
| | 推定の証明 (Estimation) | [pf_estimation.pdf](https://github.com/Andriyichenko/research/semi/out/pf_estimation.pdf) |
